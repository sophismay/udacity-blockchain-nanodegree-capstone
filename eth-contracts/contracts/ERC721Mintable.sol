...
contract Ownable {
    ...
    modifier onlyOwner() {
        require(msg.sender == _owner, "ONLY OWNER: ONLY OWNER CAN CALL THIS FUNCTION!");
        _;
    }
    ...
    function transferOwnership(address newOwner) public onlyOwner {
        ...
        require(newOwner != address(0), "ZERO ADDRESS: ZERO ADDRESS CAN'T BE OWNER!");
        _owner = newOwner;
    }
...
contract Pausable is Ownable {
    ...
    modifier whenNotPaused() {
        require(_paused == false, "WHEN NOT PAUSED: CONTRACT PAUSED!");
        _;
    }

    modifier paused() {
        require(_paused == true, "PAUSED: CONTRACT NOT PAUSED");
        _;
    }
    ...
    /**
     * @dev set paused state of contract
     */
...
//    @dev Approves another address to transfer the given token ID
    ...
    function _mint(address to, uint256 tokenId) internal {
        ...
        require(to != address(0), "MINT: ADDRESS INVALID");
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(from == _tokenOwner[tokenId], "TRANSFER FROM: YOU DO NOT OWN THE TOKEN!");

        // TODO: require token is being transfered to valid address
        require(to != address(0), "TRANSFER FROM: INVALID TO ADDRESS!");
...
contract ERC721Metadata is ERC721Enumerable, usingOraclize {
    ...
    function tokenURI(uint256 tokenId) public view returns (string memory) {
        require(_exists(tokenId), "TOKEN URI: TOKEN ID DOES NOT EXIST");
    ...
    function setTokenURI(uint256 tokenId) internal {
        require(_exists(tokenId),"SET TOKEN URI: TOKEN ID DOES NOT EXIST");
